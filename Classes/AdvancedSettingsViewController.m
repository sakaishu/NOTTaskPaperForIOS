...
- (void)constructTableGroups {
	...
	if (IS_IPAD) {
		IFLinkCellController *linkCell = [[IFLinkCellController alloc] initWithLabel:NSLocalizedString(@"Extended Keyboard", nil) usingController:[[ExtendedKeyboardSettingsViewController alloc] init] inModel:model];
		[groupOneCells addObject:linkCell];	
	}
	
	IFSwitchCellController *passcodeCell = [[IFSwitchCellController alloc] initWithLabel:NSLocalizedString(@"Passcode", nil) atKey:PasscodeEnableDefaultsKey inModel:self.model];
...
#if defined(WRITEROOM) || defined(TASKPAPER)
	IFSwitchCellController *showStatusBarCell = [[IFSwitchCellController alloc] initWithLabel:NSLocalizedString(@"Status Bar", nil) atKey:ShowStatusBarDefaultsKey inModel:self.model];
...
#ifdef TASKPAPER
    IFTextCellController *defaultTagsCell = [[IFTextCellController alloc] initWithLabel:NSLocalizedString(@"Default Tags", nil) andPlaceholder:@"" atKey:DefaultTagsKey inModel:model];
    defaultTagsCell.keyboardType = UIKeyboardTypeDefault;
    [groupOneCells addObject:defaultTagsCell];
	
	IFSwitchCellController *dateDoneCell = [[IFSwitchCellController alloc] initWithLabel:NSLocalizedString(@"Add Date to Done", nil) atKey:AddDateToDoneTagKey inModel:model];
    [groupOneCells addObject:dateDoneCell];
	
	IFSwitchCellController *enableLiveSearch = [[IFSwitchCellController alloc] initWithLabel:NSLocalizedString(@"Enable Live Search", nil) atKey:LiveSearchEnabledKey inModel:model];
    [groupOneCells addObject:enableLiveSearch];
    
    IFSwitchCellController *showIconBadgeNumber =
    [[IFSwitchCellController alloc] initWithLabel:NSLocalizedString(@"Show Badge Number", nil) atKey:ShowIconBadgeNumberDefaultsKey inModel:model];
...
#if defined(WRITEROOM) || defined(TASKPAPER)
	IFSwitchCellController *draggableScroller = [[IFSwitchCellController alloc] initWithLabel:NSLocalizedString(@"Draggable Scroller", nil) atKey:DraggableScrollerDefaultsKey inModel:self.model];
	[groupOneCells addObject:draggableScroller];	
#endif
		
	if (!IS_IPAD) {
		IFSwitchCellController *switchCell = [[IFSwitchCellController alloc] initWithLabel:NSLocalizedString(@"Lock Orientation", nil) atKey:LockOrientationDefaultsKey inModel:self.model];
		switchCell.updateTarget = self;
		switchCell.updateAction = @selector(lockOrientationChanged:);
		[groupOneCells addObject:switchCell];
	}	
	
	IFSwitchCellController *capitializeTitlesCell = [[IFSwitchCellController alloc] initWithLabel:NSLocalizedString(@"ALL-CAPS Headings", nil) atKey:AllCapsHeadingsDefaultsKey inModel:self.model];
	...
	IFSwitchCellController *showFileExtensionsCell = [[IFSwitchCellController alloc] initWithLabel:NSLocalizedString(@"Show File Extensions", nil) atKey:ShowFileExtensionsDefaultsKey inModel:self.model];
...
#if defined(WRITEROOM) || defined(TASKPAPER)
    IFTextCellController *textFileDefaultExtensionCell = [[IFTextCellController alloc] initWithLabel:NSLocalizedString(@"New File Extension", nil) andPlaceholder:nil atKey:TextFileDefaultExtensionDefaultsKey inModel:self.model];
	...
	IFLinkCellController *linkCell = [[IFLinkCellController alloc] initWithLabel:NSLocalizedString(@"Debug", nil) usingController:[[DebugSettingsViewController alloc] init] inModel:model];
